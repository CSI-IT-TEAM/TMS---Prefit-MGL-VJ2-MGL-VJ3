...
namespace FORM
{
    public partial class FRM_MGL_DAILY_PRODUCTION_V2 : Form
    {
        public FRM_MGL_DAILY_PRODUCTION_V2()
        {
            InitializeComponent();
        }
        ...
        private void FRM_MGL_DAILY_PRODUCTION_VisibleChanged(object sender, EventArgs e)
        {
            try
            {
                if (this.Visible)
                {
                    lbltitle.Text = ComVar.Var._strValue1.Equals("TOT") ? "VJ1,VJ2 Production Status by Day" : ComVar.Var._strValue1 + " Production Status by Day";
                    cCount = 60;
