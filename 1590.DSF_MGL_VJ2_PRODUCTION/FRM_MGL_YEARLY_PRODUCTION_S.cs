...
namespace FORM
{
    public partial class FRM_MGL_YEARLY_PRODUCTION_S : Form
    {
        public FRM_MGL_YEARLY_PRODUCTION_S()
        {
            InitializeComponent();
        }
        ...
        public DataTable SMT_PROD_YEARLY_SELECT(string ARG_TYPE, string ARG_DATE, string ARG_LINE_CD, string ARG_MLINE_CD)
        {
            ...
            try
            {
                string process_name = "MES.PKG_MGL_VJ2.MGL_PRODUCTION_YEARLY_SUPPORT";
        ...
        private void FRM_PROD_STATUS_DAILY_VisibleChanged(object sender, EventArgs e)
        {
            if (this.Visible)
            {
                lbltitle.Text = ComVar.Var._strValue1.Equals("TOTAL1") ? "VJ1 Support Production Status by Year" : ComVar.Var._strValue2 + " Production Status by Year";
