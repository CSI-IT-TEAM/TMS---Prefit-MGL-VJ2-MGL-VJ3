...
namespace FORM
{
    public partial class FRM_MGL_YEARLY_PRODUCTIVITY_8LINE : Form
    {
        
    

        public FRM_MGL_YEARLY_PRODUCTIVITY_8LINE()
        {
            InitializeComponent();
        }
       ...
       Form[] arrForm = new Form[3];
        ...
        public FRM_MGL_YEARLY_PRODUCTIVITY_8LINE(string Title, int _indexScreen, string wh_cd, string mline_cd)
        {
        ...
        private void load_data()
        {
            ...
            else
            {
                ...
                CreateChartLine(Chart3, select_Data("003", ds.Tables[0]), "Line 3");
                CreateChartLine(Chart4, select_Data("004", ds.Tables[0]), "Line 4");
                CreateChartLine(Chart5, select_Data("005", ds.Tables[0]), "Line 5");
                CreateChartLine(Chart6, select_Data("006", ds.Tables[0]), "Line 6");
