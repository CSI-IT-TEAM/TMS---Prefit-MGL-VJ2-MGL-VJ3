...
namespace FORM
{
    public partial class FRM_MGL_DAILY_PRODUCTION_8LINE : Form
    {
        public FRM_MGL_DAILY_PRODUCTION_8LINE()
        {
            InitializeComponent();
        }
        ...
        private void BindingChart()
        {
            ...
            if (ComVar.Var._strValue1 == "TOTAL2")
            {
                ...
                CreateChart(ComVar.Var._strValue1, "201", "FGA", chart3_LE, "LD");
                CreateChart(ComVar.Var._strValue1, "202", "FGA", chart4_LE, "LE");
            ...
            else
            {
                ...
                tableLayoutPanel1.RowStyles[0].SizeType = SizeType.Percent;
                CreateChart(ComVar.Var._strValue1, "001", "FGA", chart1_LE, "Line 1");
                CreateChart(ComVar.Var._strValue1, "002", "FGA", chart2_LE, "Line 2");
                CreateChart(ComVar.Var._strValue1, "003", "FGA", chart3_LE, "Line 3");
                CreateChart(ComVar.Var._strValue1, "004", "FGA", chart4_LE, "Line 4");
                CreateChart(ComVar.Var._strValue1, "005", "FGA", chart5_LE, "Line 5");
                CreateChart(ComVar.Var._strValue1, "006", "FGA", chart6_LE, "Line 6");
            }
