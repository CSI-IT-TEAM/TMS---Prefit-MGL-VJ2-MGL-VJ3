...
namespace FORM
{
    public partial class FRM_MGL_YEARLY_PRODUCTIVITY_S : Form
    {
        public FRM_MGL_YEARLY_PRODUCTIVITY_S()
        {
            InitializeComponent();
        }
        ...
        public DataTable SMT_PROD_YEARLY_SELECT(string ARG_TYPE, string ARG_DATE, string ARG_LINE_CD, string ARG_MLINE_CD)
        {
            ...
            try
            {
                string process_name = "MES.PKG_MGL_VJ2.MGL_PRODUCTIVITY_YEAR_SUPPORT";
        ...
        private void FRM_PROD_STATUS_DAILY_VisibleChanged(object sender, EventArgs e)
        {
            if (this.Visible)
            {
                lbltitle.Text = ComVar.Var._strValue1.Equals("TOTAL1") ? "VJ1 Support Productivity Status by Year" : ComVar.Var._strValue2 + " Productivity  Status by Year";
