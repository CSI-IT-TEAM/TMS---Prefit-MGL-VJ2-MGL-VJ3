...
namespace FORM
{
    public partial class FRM_MGL_WEEKLY_PRODUCTION_S : Form
    {
        public FRM_MGL_WEEKLY_PRODUCTION_S()
        {
            InitializeComponent();
        }
        ...
        public DataTable SMT_PROD_WEEKLY_SELECT(string ARG_DATE, string ARG_LINE_CD, string ARG_MLINE_CD)
        {
            ...
            try
            {
                string process_name = "MES.PKG_MGL_VJ2.MGL_PRODUCTION_WEEKLY_SUPPORT";
