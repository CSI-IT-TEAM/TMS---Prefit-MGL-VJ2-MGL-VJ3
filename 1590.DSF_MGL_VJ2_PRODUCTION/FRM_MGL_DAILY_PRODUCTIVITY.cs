...
namespace FORM
{
    public partial class FRM_MGL_DAILY_PRODUCTIVITY : Form
    {
        
    

        public FRM_MGL_DAILY_PRODUCTIVITY()
        {
            InitializeComponent();
        }
       ...
       int _iTime;
        ...
        public FRM_MGL_DAILY_PRODUCTIVITY(string Title, int _indexScreen, string wh_cd, string mline_cd)
        {
        ...
        private void load_data()
        {
          ...
          //  DataTable dt = select_Data("UPC",  ds.Tables[0]);
            ...
            else
            {
                ...
                CreateChartLine(Chart4, select_Data("003", ds.Tables[1]), "Line 3");
                CreateChartLine(Chart5, select_Data("004", ds.Tables[1]), "Line 4");
