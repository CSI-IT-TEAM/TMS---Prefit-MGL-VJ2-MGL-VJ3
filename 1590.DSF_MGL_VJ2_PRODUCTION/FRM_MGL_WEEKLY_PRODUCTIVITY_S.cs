...
namespace FORM
{
    public partial class FRM_MGL_WEEKLY_PRODUCTIVITY_S : Form
    {
        public FRM_MGL_WEEKLY_PRODUCTIVITY_S()
        {
            InitializeComponent();
        }
        ...
        public DataTable SMT_PROD_WEEKLY_SELECT(string ARG_DATE, string ARG_LINE_CD, string ARG_MLINE_CD)
        {
            ...
            try
            {
                string process_name = "MES.PKG_MGL_VJ2.MGL_PRODUCTIVITY_WEEK_SUPPORT";
        ...
        private void FRM_PROD_STATUS_DAILY_VisibleChanged(object sender, EventArgs e)
        {
            if (this.Visible)
            {
                ...
                lbltitle.Text = ComVar.Var._strValue1.Equals("TOTAL1") ? "VJ1 Support Productivity Status by Week" : ComVar.Var._strValue2 + " Productivity  Status by Week";
                cCount = 30-1;
