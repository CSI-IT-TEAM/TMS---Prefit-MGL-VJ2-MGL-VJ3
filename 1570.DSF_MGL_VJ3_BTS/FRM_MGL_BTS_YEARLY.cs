...
namespace FORM
{
    public partial class FRM_MGL_BTS_YEARLY : Form
    {
        ...
        private void Form_VisibleChanged(object sender, EventArgs e)
        {
            ...
            if (this.Visible)
            {
                lblTitle.Text = ComVar.Var._strValue1.Equals("TOT") ? "VJ1,VJ2 Support BTS by Year" : ComVar.Var._strValue1 + " Support BTS by Year";
                DWMY.YMD_Change(4); DWMY.YMD_Change(2);
                _iCountReload = 40;
                tmrDate.Start();
        ...
        public DataTable SMT_EMD_BTS_MONTHLY_SELECT(string ARG_TYPE, string ARG_DATE, string ARG_LINE_CD, string ARG_MLINE_CD)
        {
            ...
            try
            {
                string process_name = "MES.PKG_MGL_VJ3.MGL_BTS_YEAR_DATA_SELECT";
