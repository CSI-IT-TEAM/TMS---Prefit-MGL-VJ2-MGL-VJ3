...
namespace FORM
{
    public partial class FRM_TMS_PREFIT_OUTGOING : Form
    {
            ...
            if (this.Visible)
            {
                try
                {
                   ...
                   // lblTitle.Text = string.Concat(System.Globalization.CultureInfo.CurrentCulture.TextInfo.ToTitleCase(ComVar.Var._strValue3.ToLower()), " Outgoing Status");
                    ...
                    labelControl7.Text = string.Concat("★ ", ComVar.Var._strValue3, " OUTGOING BY ASSEMBLY DAY ");
                    labelControl1.Text = string.Concat("★ ", ComVar.Var._strValue3, " OUTGOING DETAIL BY TODAY ");
                    labelControl2.Text = string.Concat("★ ", ComVar.Var._strValue3, " OUTGOING BY ASSEMBLY DAY ");
        ...
        private void BindingData(string Factory, string ProcCode, string isBottom)
        {
            try
            {
                ...
                if (dtG != null)
                {
                    ...
                    gridView1.Columns["PFC_PART_NO"].Visible = false;
                ...
                if (dtC != null)
                {
                    ...
                    chartControl1.Series[0].ArgumentDataMember = "ASY_YMD";
        ...
        private void gridView1_RowCellStyle(object sender, DevExpress.XtraGrid.Views.Grid.RowCellStyleEventArgs e)
        {
            try
            {
                string TotRow = gridView1.GetRowCellDisplayText(e.RowHandle, "MODEL_NM").ToString();
                if (TotRow.Equals("TOTAL"))
                {
                    e.Appearance.BackColor = Color.FromArgb(249, 252, 177);
                }
            }
            catch { }
        }
