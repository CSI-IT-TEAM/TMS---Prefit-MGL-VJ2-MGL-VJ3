...
namespace FORM
{
    public partial class FRM_SMT_EMD : Form
    {
        public FRM_SMT_EMD()
        {
            InitializeComponent();
        ...
        int _iCountReload = 0;
        UC.NavBarTree nvFactory = new UC.NavBarTree("Factory");
        ...
        { 
            ...
            if (dt != null && dt.Rows.Count > 0)
            {
                ...
                if (Convert.ToDouble(dt.Rows[0]["P_RATE"]) >= 99)
                {  lblPRate_Per.BackColor = Color.Green;
                    lblPRate_Per.ForeColor = Color.White;
                }
                else if (Convert.ToDouble(dt.Rows[0]["P_RATE"]) >= 97)
                {
        ...
        private void FormatGrid()
        {
            try
            {
                ...
                for (int i = 0; i < grdView.Columns.Count; i++)
                {
                    ...
                    grdView.Columns[i].AppearanceCell.Font = new System.Drawing.Font("Calibri", 21, FontStyle.Bold);
        ...
        private void FormatGridB()
        {
            try
            {
                ...
                for (int i = 0; i < grdViewB1.Columns.Count; i++)
                {
                    ...
                    grdViewB1.Columns[i].AppearanceCell.Font = new System.Drawing.Font("Calibri", 21, FontStyle.Bold);
                ...
                grdViewB1.SetRowCellValue(0, "DIV", "S.Plan (Prs)");
        ...
        private void spl2_2_SplitterMoved(object sender, SplitterEventArgs e)
        {
        ...
        {
            ((Button)sender).BackgroundImage = FORM.Properties.Resources.FtyButtonHover;
            ((Button)sender).ForeColor = Color.Blue;
        }

        private void button_MouseLeave(object sender, EventArgs e)
        {
            ((Button)sender).BackgroundImage = FORM.Properties.Resources.FtyButton;
