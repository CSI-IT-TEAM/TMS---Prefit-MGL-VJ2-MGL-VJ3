...
namespace FORM
{
    class Database
    {
        ...
        public DataTable SEL_OS_PRODUCTION_DATA(string ARG_QTYPE)
        {
            ...
            try
            {
                string process_name = "MES.PKG_SMT_B1_INSOLE.INE_PRINTING_PRODUCTION_SELECT";
        ...
        public DataTable SEL_OS_INV_DATA(string ARG_QTYPE)
        {
            ...
            try
            {
                string process_name = "MES.PKG_SMT_B1_INSOLE.INE_PRINTING_INV_SELECT";
        ...
        public DataTable SEL_OS_POD_DATA(string ARG_QTYPE)
        {
            ...
            try
            {
                string process_name = "MES.PKG_SMT_B1_INSOLE.INE_PRINTING_POD_SELECT";
        ...
        public DataTable SEL_OS_ABSENT_DATA(string ARG_QTYPE)
        {
            ...
            try
            {
                string process_name = "MES.PKG_SMT_B1_INSOLE.INE_PRINTING_HR_SELECT";
