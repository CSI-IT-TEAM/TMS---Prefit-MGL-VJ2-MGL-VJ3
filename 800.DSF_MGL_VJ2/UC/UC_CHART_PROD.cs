...
namespace FORM.UC
{
    public partial class UC_CHART_PROD : UserControl
    {
        ...
        private DataTable SP_MGL_HOME_CHART_DETAIL_SELECT(string V_P_TYPE, string V_P_FACTORY)
        {
            ...
            try
            {
                string process_name = "MES.PKG_MGL_VJ2.MGL_HOME_CHART_DETAIL_SELECT";
        ...
        private DataTable SP_MGL_SET_TREELIST(string ARG_TYPE, string ARG_DATE, string ARG_PLANT)
        {
            ...
            try
            {
                string process_name = "MES.PKG_MGL_VJ2.SP_MGL_SET_TREELIST";
        ...
        private DataTable SP_MGL_TREELIST_CHART_DETAIL(string ARG_TYPE, string ARG_DATE, string ARG_PLANT)
        {
            ...
            try
            {
                string process_name = "MES.PKG_MGL_VJ2.SP_MGL_TREELIST_CHART_DETAIL";
                MyOraDB.ReDim_Parameter(4);
                MyOraDB.Process_Name = process_name;
                MyOraDB.Parameter_Name[0] = "ARG_TYPE";
                MyOraDB.Parameter_Name[1] = "ARG_DATE";
        ...
        {
            sFactory = dt.Rows[0]["LINE_CD"].ToString();
            ...
            if (type == "HR")
            {
                ...
                chartControl2.Series[1].ArgumentDataMember = "LINE_NM";
                ...
                chartControl2.Series[2].ArgumentDataMember = "LINE_NM";
        ...
        private void chartControl1_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                DataTable dt = SP_MGL_HOME_CHART_DETAIL_SELECT("Q", sFactory);
                DataTable dtTree = SP_MGL_SET_TREELIST("Q", DateTime.Now.ToString("yyyyMMdd"), sFactory);
                DataTable dtTreeDetailChart = SP_MGL_TREELIST_CHART_DETAIL("Q", DateTime.Now.ToString("yyyyMMdd"), sFactory);
        ...
        void OnDateChanging(string date)
        {
            ...
            {
                this.Cursor = Cursors.WaitCursor;
                DataTable dtTree = SP_MGL_SET_TREELIST("Q", date, sFactory);
                DataTable dtTreeDetailChart = SP_MGL_TREELIST_CHART_DETAIL("Q", date, sFactory);
