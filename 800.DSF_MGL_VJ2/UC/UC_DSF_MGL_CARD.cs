...
namespace FORM.UC
{
    public partial class UC_DSF_MGL_CARD : UserControl
    {
        ...
        {
            if (!Directory.Exists(@"C:\\PFC_MGL_" + LineName))
            {
                ...
                if (dl == DialogResult.Yes)
                    Directory.CreateDirectory(@"C:\\PFC_MGL_" + LineName);
            }

            OpenFileDialog theDialog = new OpenFileDialog();
            theDialog.Title = "Open PFC File";
            theDialog.Filter = "PDF files|*.pdf";
            theDialog.InitialDirectory = @"C:\PFC_MGL_" + LineName;
        ...
        private void lblFac_Click(object sender, EventArgs e)
        {
            ...
            else if (_FacCode.Equals("201") )
            {
                ComVar.Var.callForm = "69";
            }else if (_FacCode.Equals("202"))
            {
