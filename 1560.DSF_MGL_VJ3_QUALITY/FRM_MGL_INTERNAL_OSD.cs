...
namespace FORM
{
    public partial class FRM_MGL_INTERNAL_OSD : Form
    {
        ...
        private DataTable MGL_I_QSD_DATA_SELECT(string ARG_TYPE, string ARG_FROM, string ARG_TO)
        {
            ...
            MyOraDB.Process_Name = "MES.PKG_MGL_VJ3.MGL_I_QSD_DATA_SELECT";
        ...
        private void FRM_MGL_INTERNAL_OSD_VisibleChanged(object sender, EventArgs e)
        {
            if (this.Visible)
            {
                ...
                lbltitle.Text = ComVar.Var._strValue1.Equals("TOT") ? "VJ1,VJ2 Support Internal OS&&D by Month" : ComVar.Var._strValue1 + " Support Internal OS&&D by Month";
                this.Cursor = Cursors.Default;
            }
            else
            { }
