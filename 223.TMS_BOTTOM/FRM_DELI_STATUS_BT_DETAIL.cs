...
namespace FORM
{
    public partial class FRM_DELI_STATUS_BT_DETAIL : Form
    {
        public FRM_DELI_STATUS_BT_DETAIL()
        {
            InitializeComponent();
        }
        int iCount = 0;
        ...
        {
            DatabaseTMS db = new DatabaseTMS();
            ds = db.TMS_DELIVERY_DETAIL("MES.PKG_TMS_DASHBOARD.TMS_DELIVERY_DETAIL_V1", "VJ", ComVar.Var._strValue3, ComVar.Var._strValue4, DateTime.Now.ToString("yyyyMMdd"), string.IsNullOrEmpty(ComVar.Var._strValue1) ? "ALL" : ComVar.Var._strValue1);
