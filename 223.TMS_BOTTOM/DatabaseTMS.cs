...
namespace FORM
{
    public class DatabaseTMS
    {
        ...
        public DataTable getSetStatus1(string ARG_QTYPE, string ARG_OP_CD, string ARG_CMP_CD, string ARG_YMD, string ARG_LINE_CD)
        {
            try
            {
                COM.OraDB MyOraDB = new COM.OraDB();
                ...
                string process_name = "MES.PKG_TMS_HOME.TMS_SET_STATUS_SEL";
                MyOraDB.ReDim_Parameter(6);
                MyOraDB.Process_Name = process_name;
                MyOraDB.Parameter_Name[0] = "ARG_QTYPE";
                MyOraDB.Parameter_Name[1] = "ARG_OP_CD";
