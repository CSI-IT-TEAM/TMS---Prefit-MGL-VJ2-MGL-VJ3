...
namespace FORM
{
    public partial class FRM_SET_STATUS_BY_HOME : Form
    {
        public FRM_SET_STATUS_BY_HOME()
        {
            InitializeComponent();
        }
        ...
        private void FRM_SET_STATUS_V1_VisibleChanged(object sender, EventArgs e)
        {
            if (this.Visible)
            {
                ...
                lblTitle.Text = ComVar.Var._strValue5.ToUpper() + " SET BALANCE STATUS";
        ...
        private void BindingData(string Qtype)
        {
            ...
            try
            {
                ...
                DataTable dt1 = db.getSetStatus1(Qtype, ComVar.Var._strValue3, ComVar.Var._strValue4, "", ComVar.Var._strValue1);
            ...
            try
            {
                ...
                for (int i = 0; i < gridView1.Columns.Count; i++)
                {
                    ...
                    if (i < 5)
                    {
                        ...
                        gridView1.Columns[i].Caption = gridView1.Columns[i].ToString().Replace("MLINE_CD", "Line").Replace("STYLE_CD", "Style Code").Replace("INFO_NM", "DIV").Replace("LINE_NM","Plant").Replace("MODEL_NM","Model Name");
        ...
        private void gridView1_CellMerge(object sender, DevExpress.XtraGrid.Views.Grid.CellMergeEventArgs e)
        {
            try
            {
                ...
                {
                    string ymd1 = gridView1.GetRowCellDisplayText(e.RowHandle1, "LINE_NM").Trim() + gridView1.GetRowCellDisplayText(e.RowHandle1, "MLINE_CD").Trim() + gridView1.GetRowCellDisplayText(e.RowHandle1, e.Column.FieldName).Trim() + gridView1.GetRowCellDisplayText(e.RowHandle1, "STYLE_CD").Trim();
                    string ymd2 = gridView1.GetRowCellDisplayText(e.RowHandle2, "LINE_NM").Trim() + gridView1.GetRowCellDisplayText(e.RowHandle2, "MLINE_CD").Trim() + gridView1.GetRowCellDisplayText(e.RowHandle2, e.Column.FieldName).Trim() + gridView1.GetRowCellDisplayText(e.RowHandle2, "STYLE_CD").Trim();
