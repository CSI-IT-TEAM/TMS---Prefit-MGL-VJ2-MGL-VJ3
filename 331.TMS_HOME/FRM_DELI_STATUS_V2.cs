...
namespace FORM
{
    public partial class FRM_DELI_STATUS_V2 : Form
    {
        public FRM_DELI_STATUS_V2()
        {
            InitializeComponent();
        }
        ...
        private void GetChartShortageByComponent()
        {
            try
            {
                ...
                gridControl1.DataSource = ds.Tables[5];
                    ...
                    gridView1.Columns["ASY_YMD"].AppearanceCell.TextOptions.HAlignment = HorzAlignment.Center;
