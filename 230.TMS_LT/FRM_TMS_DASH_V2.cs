...
namespace FORM
{
    public partial class FRM_TMS_DASH_V2 : Form
    {
        public FRM_TMS_DASH_V2()
        {
            InitializeComponent();
        ...
        private void BindingChart2(DataSet dt, bool isToday)
        {
            try
            {
                lblShortToday.Text = "No Shortage.";
                lblShortYesterday.Text = "No Shortage.";
                ...
                if (dt.Tables[1].Select("YT = 'TODAY'").Count() > 0)
                {
                    ...
                    chartControl5.Series[0].ArgumentDataMember = "CMP_CD";
                    chartControl5.Series[0].ValueDataMembers.AddRange(new string[] { "SHR_QTY" });
                    chartControl5.Series[1].ArgumentDataMember = "CMP_CD";
                    chartControl5.Series[1].ValueDataMembers.AddRange(new string[] { "SHR_QTY" });
                }
                else
                ...
                if (dt.Tables[1].Select("YT = 'YESTERDAY'").Count() > 0)
                {
                    ...
                    chartControl4.Series[0].ValueDataMembers.AddRange(new string[] { "SHR_QTY" });
                    chartControl4.Series[1].ArgumentDataMember = "CMP_CD";
                    chartControl4.Series[1].ValueDataMembers.AddRange(new string[] { "SHR_QTY" });
                }
                else
