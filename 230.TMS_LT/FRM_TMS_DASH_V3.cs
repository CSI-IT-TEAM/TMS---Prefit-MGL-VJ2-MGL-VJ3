...
namespace FORM
{
    public partial class FRM_TMS_DASH_V3 : Form
    {
        public FRM_TMS_DASH_V3()
        {
            InitializeComponent();
        ...
        private void FRM_TMS_DASH_Load(object sender, EventArgs e)
        {
            ...
            defController.SetToolTip(chartControl4, "Click Here To View By Trip");
            defController.SetToolTip(chartControl5, "Click Here To View By Trip");
        ...
        private void tmrLoad_Tick(object sender, EventArgs e)
        {
            ...
            if (cCount >= 60)
            {
                ...
                //BindingChart();
                DataSet ds = Sel_Data_Chart("MES.SP_TMS_DASHBOARD_Q4", _LINE, _MLINE, _DATE);
                BindingChart1(ds, 3);
